...
// Copyright ÂŠ 2012 - 2014 client IO (http://client.io)
...
(function(root, factory) {
    ...
    var bezier = {
        ...
        // a parametric curve x = x(t)/w(t), y = y(t)/w(t), ďŹnd the parameter value t
	...
	interpolate: {
        ...
        format: {
            ...
            prefix: function(value, precision) {
                ...
                var prefixes = _.map(['y','z','a','f','p','n','Âľ','m','','k','M','G','T','P','E','Z','Y'], function(d, i) {
